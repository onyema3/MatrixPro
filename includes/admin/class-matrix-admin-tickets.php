            ...
            <table class="wp-list-table widefat fixed striped" style="margin-top: 30px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo esc_html(date('M d, Y H:i', strtotime($ticket->updated_at))); ?></td>
                        <td><a href="<?php echo esc_url(admin_url('admin.php?page=matrix-mlm-tickets&action=view&id=' . (int) $ticket->id)); ?>" class="button button-small"><?php _e('View', 'matrix-mlm'); ?></a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="wrap matrix-admin-wrap">
            ...
            <div class="matrix-admin-card">
                <div class="matrix-ticket-meta">
                    ...
                    <span><strong><?php _e('Created:', 'matrix-mlm'); ?></strong> <?php echo esc_html(date('M d, Y H:i', strtotime($ticket->created_at))); ?></span>
                </div>
            </div>
